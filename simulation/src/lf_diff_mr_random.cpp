...
int main(int argc, char* argv[])
{
  ...
  std::cout << "Warm up steps = " << warm_up_steps << std::endl;
  ...
  for (size_t n = 0; n < warm_up_steps; ++n)
  {
    tree.warm_up_random();
  ...
  for (size_t j = 0; j < n_steps; ++j)
  {
    ...
    else
    {
      ...
      tree.set_mutations_diff_mr_random(engine, MUT_rate_higher);
      //std::cout << tree;
